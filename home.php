                ...
                <ul class="album-list" id="albumList">
                    <?php foreach ($albums as $album): ?>
                        <li class="album-item <?php echo $album['is_default'] ? 'default-album' : ''; ?>"
                            data-album-id="<?php echo $album['id']; ?>" data-album-name="<?php echo h($album['name']); ?>"
    ...
    <div class="modal-content">
        ...
        <form id="photoForm" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea id="caption" name="caption" rows="3" placeholder="寫下這張照片的故事..."></textarea>
            </div>
            ...
            <div class="form-group">
                ...
                <select id="albumSelect" name="album_id">
                    <?php foreach ($albums as $album): ?>
                        <option value="<?php echo $album['id']; ?>" <?php echo $album['is_default'] ? 'selected' : ''; ?>>
    ...
    <div class="modal-content modal-sm">
        ...
        <form id="albumForm">
            ...
            <div class="form-group">
                ...
                <input type="text" id="albumName" name="album_name" required placeholder="例如：旅遊回憶、美食紀錄">
            </div>
